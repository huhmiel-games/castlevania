 ...
 * @extends {State}
 */
export default class ProximityState extends State
{
    ...
    public enter(scene: GameScene, character: Enemy)
    {
        ...
        const distance = Phaser.Math.Distance.BetweenPoints(character, player);

        // if (character.canUse(EPossibleState.FLY) && distance < character.ai[character.currentStateIndex].distance!)
        // {
        //     this.stateMachine.transition(EPossibleState.FLY, this.stateMachine.state);
